...
import CheckGray from "../../Assets/Images/check circle_1.svg";
import CheckGreen from "../../Assets/Images/check circle_.svg"
            ...
            <Main>
                ...
                <Force>
                    <Momentum>
                        ...
                        <Bluebox>
                            <Right><Arrow><Image src={require("../../Assets/Images/playbutton.png").default} /></Arrow></Right>
                            <Left><Text>join</Text></Left>
                        </Bluebox>      
                    </Momentum>
                    <Bottom>
                        <Mass>
                            <Item><Round><Tick src={CheckGray}  alt="image"/></Round>Force and unit</Item>
                            <Item><Round><Tick src={CheckGreen} alt="image"/></Round>Mass and acceleration</Item>
                            <Item><Round><Tick src={CheckGreen} alt="image"/></Round>Gain of Momentum</Item>
                        </Mass>
                        <Mass>
